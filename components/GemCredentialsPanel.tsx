...
import { FiKey, FiUser, FiLock, FiMail, FiSave, FiEdit3, FiSearch, FiX, FiEye, FiEyeOff, FiTrash2, FiPlus, FiLogIn } from "react-icons/fi";
...
// Reusable core of GeM Login Setup - shared by its own full page
// (app/dashboard/orders/gem-credentials/page.tsx, which just adds the Back
// button/page chrome around this) and the Header's quick-access popup, the
// same split already used for Urgent Tasks (UrgentTaskManagerPanel).
export default function GemCredentialsPanel() {
